...
var G__10670 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10670,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10670;
}
});
...
var len__4730__auto___10675 = arguments.length;
var i__4731__auto___10676 = (0);
while(true){
if((i__4731__auto___10676 < len__4730__auto___10675)){
args__4736__auto__.push((arguments[i__4731__auto___10676]));

var G__10677 = (i__4731__auto___10676 + (1));
i__4731__auto___10676 = G__10677;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10672){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10673,G__10674,seq10672__$2);
});
...
var file = cljs.core.get.call(null,map__10679__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10679__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10679__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10679,map__10679__$1,file,line,column){
return (function (p1__10678_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10678_SHARP_));
});})(map__10679,map__10679__$1,file,line,column))
...
var temp__5457__auto___10681 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10681)){
var message_10682 = temp__5457__auto___10681;
...
var temp__5457__auto___10683 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10683)){
var message_10684 = temp__5457__auto___10683;
cljs.core.println.call(null,message_10684);
} else {
}
...
var output_dir__$1 = (function (){var G__10685 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10685,"/"].join('');
} else {
return G__10685;
}
})();
...
var G__10687 = exception.stack;
var G__10687__$1 = (((G__10687 == null))?null:clojure.string.split_lines.call(null,G__10687));
var G__10687__$2 = (((G__10687__$1 == null))?null:cljs.core.get.call(null,G__10687__$1,depth));
if((G__10687__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10687__$2);
}
} else {
...
var vec__10688 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10688,(0),null);
var column = cljs.core.nth.call(null,vec__10688,(1),null);
var vec__10691 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10691,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10691,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10691,(2),null);
...
var m__$1 = (function (){var G__10694 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10698 = (function (){var G__10697 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10697);
} else {
return G__10697;
}
})();
...
return cljs.core.vary_meta.call(null,G__10699,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e10700){var e = e10700;
var G__10701 = e;
var G__10701__$1 = (((G__10701 instanceof cljs.core.Keyword))?G__10701.fqn:null);
switch (G__10701__$1) {
...
var vec__10703 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10703,(0),null);
var types = vec__10703;
...
return cljs.core.map.call(null,(function (p__10706){
var vec__10707 = p__10706;
var ns = cljs.core.nth.call(null,vec__10707,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10707,(1),null);
return ((function (vec__10707,ns,vars__$1){
return (function (){
...
var G__10710 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10710,G__10710__$1,env,once_fixtures,each_fixtures,vec__10707,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10710,G__10710__$1,env,once_fixtures,each_fixtures,vec__10707,ns,vars__$1){
return (function (){
var seq__10711 = cljs.core.seq.call(null,vars__$1);
var chunk__10712 = null;
var count__10713 = (0);
var i__10714 = (0);
while(true){
if((i__10714 < count__10713)){
var v = cljs.core._nth.call(null,chunk__10712,i__10714);
var temp__5457__auto___10716 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10716)){
var t_10717 = temp__5457__auto___10716;
each_fixture_fn.call(null,((function (seq__10711,chunk__10712,count__10713,i__10714,t_10717,temp__5457__auto___10716,v,each_fixture_fn,G__10710,G__10710__$1,env,once_fixtures,each_fixtures,vec__10707,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10717)));
});})(seq__10711,chunk__10712,count__10713,i__10714,t_10717,temp__5457__auto___10716,v,each_fixture_fn,G__10710,G__10710__$1,env,once_fixtures,each_fixtures,vec__10707,ns,vars__$1))
);
} else {
}


var G__10718 = seq__10711;
var G__10719 = chunk__10712;
var G__10720 = count__10713;
var G__10721 = (i__10714 + (1));
seq__10711 = G__10718;
chunk__10712 = G__10719;
count__10713 = G__10720;
i__10714 = G__10721;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__10711);
if(temp__5457__auto__){
var seq__10711__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10711__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__10711__$1);
var G__10722 = cljs.core.chunk_rest.call(null,seq__10711__$1);
var G__10723 = c__4550__auto__;
var G__10724 = cljs.core.count.call(null,c__4550__auto__);
var G__10725 = (0);
seq__10711 = G__10722;
chunk__10712 = G__10723;
count__10713 = G__10724;
i__10714 = G__10725;
continue;
} else {
var v = cljs.core.first.call(null,seq__10711__$1);
var temp__5457__auto___10726__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10726__$1)){
var t_10727 = temp__5457__auto___10726__$1;
each_fixture_fn.call(null,((function (seq__10711,chunk__10712,count__10713,i__10714,t_10727,temp__5457__auto___10726__$1,v,seq__10711__$1,temp__5457__auto__,each_fixture_fn,G__10710,G__10710__$1,env,once_fixtures,each_fixtures,vec__10707,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10727)));
});})(seq__10711,chunk__10712,count__10713,i__10714,t_10727,temp__5457__auto___10726__$1,v,seq__10711__$1,temp__5457__auto__,each_fixture_fn,G__10710,G__10710__$1,env,once_fixtures,each_fixtures,vec__10707,ns,vars__$1))
);
} else {
}


var G__10728 = cljs.core.next.call(null,seq__10711__$1);
var G__10729 = null;
var G__10730 = (0);
var G__10731 = (0);
seq__10711 = G__10728;
chunk__10712 = G__10729;
count__10713 = G__10730;
i__10714 = G__10731;
continue;
}
} else {
...
});})(each_fixture_fn,G__10710,G__10710__$1,env,once_fixtures,each_fixtures,vec__10707,ns,vars__$1))
);
});})(each_fixture_fn,G__10710,G__10710__$1,env,once_fixtures,each_fixtures,vec__10707,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10710__$1)].join('')));

}
})());
});
;})(vec__10707,ns,vars__$1))
